...
describe('Users', () => {
  describe('User Creation', () => {
    ...
    it('should not create visa-officer -> supervisor doesnt have permission to-> will create customer instead',
      async () => {
        const res = await server
          .post('/api/v1/auth/add-staff')
  ...
  describe('User Fetch Request', () => {
    ...
    it('should fetch admin details', async () => {
      ...
      expect(res.body).toHaveProperty('data');
      expect(res.body).toHaveProperty('status');
      const superAdminDetails = _.omit(
        testData.superAdmin, ['token', '__v', 'role', '$__', 'created_at', 'updated_at'],
      );
    ...
    it('should fetch supervisor details', async () => {
      ...
      expect(res.body).toHaveProperty('data');
      expect(res.body).toHaveProperty('status');
      const supervisorDetails = _.omit(
        testData.supervisor, ['token', '__v', 'role', '$__', 'created_at', 'updated_at'],
      );
