...
async getNotifications(req, res) {
  ...
  //   const user = await User.findByIdAndDelete(req.params.user_id).lean();
  //   if (isEmpty(user)) throw new this.e.DocumentMissingError();

  //   this.logger.info('User deleted successfully.');
  //   return successResponse(res, 202, {}, 'User deleted successfully.');
  // }
